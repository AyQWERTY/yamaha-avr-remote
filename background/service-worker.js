  ...
  return new Promise((resolve, reject) => {
    chrome.storage.sync.get(STORAGE_IP_KEY, (data) => {
      if (data[STORAGE_IP_KEY]) {
        ...
        reject(
          new Error(
            "Receiver IP not configured. Enter the IP in the extension popup.",
          ),
        );
      }
    });
...
function sendPowerCommand(power) {
  if (power !== "on" && power !== "standby") {
    return Promise.reject(
      new Error('Invalid power command. Use "on" or "standby".'),
    );
  }
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setPower?power=${power}`,
  );
}
...
function sendVolume(volume) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setVolume?volume=${volume}`,
  );
}
...
function setSoundProgram(program) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setSoundProgram?program=${program}`,
  );
}
...
function setExtraBass(enable) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setExtraBass?enable=${enable}`,
  );
}
...
function setEnhancer(enable) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setEnhancer?enable=${enable}`,
  );
}
...
function setBass(value) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setToneControl?bass=${value}`,
  );
}
...
function setTreble(value) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setToneControl?treble=${value}`,
  );
}
...
function setSubwoofer(value) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setSubwooferVolume?volume=${value}`,
  );
}
...
function setMute(enable) {
  return fetchYamahaApi(
    `/YamahaExtendedControl/v1/main/setMute?enable=${enable}`,
  );
}
